...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('gestion.index')" :active="route().current('gestion.index')">
                                    Gestión
                                </NavLink>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('gestion.index')" :active="route().current('gestion.index')">
                            Gestión
                        </ResponsiveNavLink>
            ...
            <!-- Breadcrumbs -->
            <div class="bg-gray-100" v-if="$slots.breadcrumbs">
